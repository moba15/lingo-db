...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // opt_sort_clause
      char dummy11[sizeof (std::optional<std::shared_ptr<lingodb::ast::OrderByModifier>>)];

      // case_arg
      char dummy12[sizeof (std::optional<std::shared_ptr<lingodb::ast::ParsedExpression>>)];

      // opt_select_limit
      char dummy13[sizeof (std::optional<std::shared_ptr<lingodb::ast::ResultModifier>>)];
