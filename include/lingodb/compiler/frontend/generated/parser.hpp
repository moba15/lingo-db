...
namespace  lingodb  {
#line 215 "/home/bachmaier/projects/lingo-db/include/lingodb/compiler/frontend/generated/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // opt_interval
      char dummy11[sizeof (std::optional<lingodb::ast::LogicalType>)];
      ...
      // opt_target_list
      char dummy40[sizeof (std::shared_ptr<lingodb::ast::TargetsExpression>)];
      ...
      // frame_extent
      // frame_bound
      char dummy42[sizeof (std::shared_ptr<lingodb::ast::WindowBoundary>)];

      // window_func_expr
      // over_clause
      // window_specification
      char dummy43[sizeof (std::shared_ptr<lingodb::ast::WindowExpression>)];
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_opt_interval: // opt_interval
        value.move< std::optional<lingodb::ast::LogicalType> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_opt_target_list: // opt_target_list
        value.move< std::shared_ptr<lingodb::ast::TargetsExpression> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_frame_bound: // frame_bound
        value.move< std::shared_ptr<lingodb::ast::WindowBoundary> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::optional<lingodb::ast::LogicalType>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::optional<lingodb::ast::LogicalType>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<lingodb::ast::TargetsExpression>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<lingodb::ast::TargetsExpression>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<lingodb::ast::WindowBoundary>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<lingodb::ast::WindowBoundary>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_opt_interval: // opt_interval
        value.template destroy< std::optional<lingodb::ast::LogicalType> > ();
        break;
      ...
      case symbol_kind::S_opt_target_list: // opt_target_list
        value.template destroy< std::shared_ptr<lingodb::ast::TargetsExpression> > ();
        break;
      ...
      case symbol_kind::S_frame_extent: // frame_extent
      case symbol_kind::S_frame_bound: // frame_bound
        value.template destroy< std::shared_ptr<lingodb::ast::WindowBoundary> > ();
        break;
  ...
  private:
    ...
    enum
    {
      yylast_ = 21234,     ///< Last index in yytable_.
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_opt_interval: // opt_interval
        value.copy< std::optional<lingodb::ast::LogicalType> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_opt_target_list: // opt_target_list
        value.copy< std::shared_ptr<lingodb::ast::TargetsExpression> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_frame_extent: // frame_extent
      case symbol_kind::S_frame_bound: // frame_bound
        value.copy< std::shared_ptr<lingodb::ast::WindowBoundary> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_opt_interval: // opt_interval
        value.move< std::optional<lingodb::ast::LogicalType> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_opt_target_list: // opt_target_list
        value.move< std::shared_ptr<lingodb::ast::TargetsExpression> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_frame_extent: // frame_extent
      case symbol_kind::S_frame_bound: // frame_bound
        value.move< std::shared_ptr<lingodb::ast::WindowBoundary> > (YY_MOVE (s.value));
        break;
...
#line 15774 "/home/bachmaier/projects/lingo-db/include/lingodb/compiler/frontend/generated/parser.hpp"
